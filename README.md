...
### 주의
해당 샘플은 실제 서비스로 활용하시면 안됩니다. 이 환경에서 어디까지 가능한지 가볍게 시연하기 위해 준비된 것으로 실서비스에 적용하시는 경우 보안과 기타 로직을 더 세밀하게 설정할 필요가 있습니다. 
### 실무용 샘플
[실무용 시연](https://github.com/t-hajongkim/hira-billing-copilot)
